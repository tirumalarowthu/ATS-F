    ...
    if (validate()) {
      ...
      await axios.post("http://localhost:9001/applicant/add", formData)
        .then(res =>{
          ...
          alert(`Applicant Added Successfully & Id is ${res.data._id}`)
        })
    ...
    <div className='container border border-2'>
      ...
      <form className="p-4 border border-2" onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          ...
          <input type="url" name="resumeLink" value={formData.resumeLink} onChange={handleChange} className="form-control" />
...
//                   name="collegeName"
//                   onChange={handleInputChange}
//                   placeholder="Enter collegeName name"
//                   id="validationCustom01"
//                   label="collegeName Name"
//                   required
//                 />
//               </CCol>
//               <CCol md={6}>
...
//                   aria-describedby="validationCustom04Feedback"
//                   id="validationCustom04"
//                   label="isExperienced/Fresher"
//                   onChange={(e) => e.target.value === "isExperienced" ? setExperience(true) : setExperience(false)}
//                   required
//                 >
//                   <option disabled>Choose...</option>
//                   <option value="Fresher">Fresher</option>
//                   <option value="isExperienced"> isExperienced</option>
//                 </CFormSelect>
//               </CCol>
//               {
//                 isExperienced ? <>
...
//                       min="1"
//                       max="20"
//                       placeholder="Enter isExperienced"
//                       id="validationCustom02"
//                       label="isExperienced in Years"
//                       required
//                     />
//                   </CCol>
//                 </> : null
...
//                   name="resumeLinkLink"
//                   onChange={handleInputChange}
//                   placeholder="Provide resumeLink link.."
//                   id="validationCustom01"
//                   label="resumeLink link"
//                   required
//                 />
//               </CCol>
//               {/* <CCol md={6}>
